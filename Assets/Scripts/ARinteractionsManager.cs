...
public class ARinteractionsManager : MonoBehaviour
{
    ...
    private bool isOver3DModel; //variable que valida si estoy sobre un objeto 3D


    //variable que se usa para girar el objeto
    ...
    void Update()
    {
        ...
        //para saber que la pantalla se ha tocado
        ...
        if (Input.touchCount > 0)
        {
            ...
            //codigo que permite rotar imagenes de Realidad Aumentada
            ...
            //para saber si el usuario esta moviendo los dedos
            ...
            //verificar que el touch sea sobre el modelo 3D
